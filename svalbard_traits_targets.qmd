...
In total, we measured the height of 77 *Bistorta vivipera* plants across the different habitats. 
The *Bistorta vivipera* in the OTC plots is 1.2 cm ± 0.39 taller than in the control plots (@fig-height-effect).
